...
public class PressaoServlet extends HttpServlet {
    ...
    private void excluir(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {
    		dao.remover(codigo);
    		request.setAttribute("msg", "Pressao removida!");
    	} catch (DBException e) {
    		e.printStackTrace();
	...
	private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int sistolica = Integer.parseInt(request.getParameter("smmhg"));
			int diastolica = Integer.parseInt(request.getParameter("dmmhg"));
			
			
			Pressao pressao = new Pressao(codigo, 1, data, hora, sistolica, diastolica); 
	...
	private void cadastrar(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			Pressao pressao = new Pressao(1, data, hora, sistolica, diastolica); 
		...
		request.getRequestDispatcher("adicionarPressao.jsp").forward(request, response);
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "abrir-form-edicao":
			...
			request.getRequestDispatcher("edicaoPressao.jsp").forward(request, response);
		}
