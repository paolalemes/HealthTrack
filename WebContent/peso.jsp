...
<body>
        ...
        <main class="batimentos container text-center">
			...
			<c:forEach items="${pesos}" var="p">
				<div class="row border-bottom">
				    ...
				    <div class="col">
				        <small>${p.peso} <small>kg</small></small>
				    </div>
				    <div class="col">
				    	<c:url value="peso" var="link">
							<c:param name="acao" value="abrir-form-edicao"/>
							<c:param name="codigo" value="${p.codigoPeso}"/>
						</c:url>
				        <a class="text-info" href="${link }"><i class="fas fa-pencil-alt"></i></a>
				        <button type="button" class="text-info border-0 shadow-0 bg-white" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value = ${p.codigoPeso}">
  							<i class="fas fa-trash"></i>
						</button>
				        <!-- <a class="text-info" href="#"><i class="fas fa-trash"></i></a>-->
				    </div>
				</div>
			</c:forEach>
        ...
        <div class="fixed-bottom text-center mb-5">
            <a class="btn btn-info rounded-pill mb-1" href="adicionarPeso.jsp">Adicionar Peso</a>
        </div>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        		Deseja realmente excluir o peso?
		      </div>
