	...
	<main class="container p-md-5">
            <div class="card border-info container mt-5">
                ...
                <div class="card-body text-center">
                    ...
                    <input type="hidden" value="${batimento.codigoBatimento }" name="codigo">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="time" name="hr" id="hr" value="${batimento.hora }" required>
                        </div>
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="number" name="bpm" id="bpm" placeholder="b.p.m." value="${batimento.batimentos }" required>
                        </div>
    
	                    <input class="btn btn-info rounded-pill text-center" value="Atualizar" type="submit">
