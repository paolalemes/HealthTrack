                ...
                <div class="card-body text-center">
                    ...
                    <input type="hidden" value="cadastrar" name="acao">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="number" name="kg" id="kg" placeholder="Kg" required>
                        </div>
    					
    					<input type="submit" value="Adicionar" class="btn btn-info rounded-pill text-center">
