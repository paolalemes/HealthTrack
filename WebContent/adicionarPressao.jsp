                ...
                <div class="card-body text-center">
                    ...
                    <input type="hidden" value="cadastrar" name="acao">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="number" name="smmhg" id="smmhg" placeholder="mmHg" required>
                        </div>
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="number" name="dmmhg" id="dmmhg" placeholder="mmHg" required>
                        </div>
